...
How to get Hously running locally. Uses Bun + Makefile for everything.

Last verified: 2026-05-25

## Prerequisites

- **Bun** ≥ 1.3 (`oven/bun:1.3.11` in CI). Hously is Bun-native — do **not** use `npm`, `yarn`, or `pnpm`.
...
| Var                                          | Purpose                                                                                                          |
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `DATABASE_URL`                               | `postgresql://hously:…@db:5432/hously` (use `localhost:5433` if you're running the API on the host)               |
