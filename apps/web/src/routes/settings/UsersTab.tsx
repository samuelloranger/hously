...
import type { CreateUserRequest } from "../../features/admin/api";
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-lg shadow p-6">
            ...
            <div className="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-neutral-700 dark:text-neutral-300">
                  <strong>{t("settings.users.email")}:</strong>{" "}
                  {createdUser.user.email}
                </p>
                {createdUser.user.first_name && (
                  <p className="text-neutral-700 dark:text-neutral-300">
                    <strong>{t("settings.users.firstName")}:</strong>{" "}
                    {createdUser.user.first_name}
                  </p>
                )}
                {createdUser.user.last_name && (
                  <p className="text-neutral-700 dark:text-neutral-300">
                    <strong>{t("settings.users.lastName")}:</strong>{" "}
                    {createdUser.user.last_name}
                  </p>
                )}
                <div className="mt-4 p-3 bg-white dark:bg-neutral-800 border border-yellow-300 dark:border-yellow-700 rounded">
                  ...
                  <p className="text-xs text-red-600 dark:text-red-400 mt-2">
                    {t("settings.users.passwordWarning")}
                  </p>
                </div>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormInput
              {...register("first_name")}
              placeholder={
                t("settings.users.firstNamePlaceholder") ||
                "First name (optional)"
              }
            />
            ...
            <FormInput
              {...register("last_name")}
              placeholder={
                t("settings.users.lastNamePlaceholder") ||
                "Last name (optional)"
              }
            />
