...
import { useResetPassword } from '@hously/shared';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <input
                ...
                {...register('confirmPassword', {
                  required: true,
                  validate: value => value === password || t('resetPassword.passwordsDoNotMatch'),
                })}
              />
              {errors.confirmPassword && (
                <p className="mt-1 text-sm text-red-600 dark:text-red-400">
                  {errors.confirmPassword.message || t('resetPassword.confirmPasswordRequired')}
                </p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            >
              {resetPasswordMutation.isPending ? t('common.loading') : t('resetPassword.submit')}
            </button>
          </div>
