...
import { ADMIN_ENDPOINTS, AUTH_ENDPOINTS, CALENDAR_ENDPOINTS, CHORES_ENDPOINTS, DASHBOARD_ENDPOINTS, QBITTORRENT_ENDPOINTS, QBITTORRENT_TORRENTS_PAGE_SIZE, EXTERNAL_NOTIFICATION_ENDPOINTS, LIBRARY_ENDPOINTS, MEAL_PLAN_ENDPOINTS, MEDIAS_ENDPOINTS, NOTIFICATION_ENDPOINTS, PLUGIN_ENDPOINTS, QUALITY_PROFILES_ENDPOINTS, RECIPES_ENDPOINTS, SHOPPING_ENDPOINTS, HABIT_ENDPOINTS, BOARD_TASKS_ENDPOINTS } from "@hously/shared/endpoints";
import type {
