...
export const hardResetServiceWorkerForPush = async (): Promise<ServiceWorkerRegistration> => {
...
export const serializeSubscription = (sub: globalThis.PushSubscription): PushSubscriptionData => ({
