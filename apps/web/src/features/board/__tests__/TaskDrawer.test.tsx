...
vi.mock('@/hooks/useUsers', () => ({
  useUsers: vi.fn().mockReturnValue({
    data: {
      users: [
        { id: 1, email: 'alice@example.com', first_name: 'Alice', last_name: 'Smith', is_admin: false, last_login: null, created_at: '2024-01-01', last_activity: null },
        { id: 2, email: 'bob@example.com', first_name: 'Bob', last_name: null, is_admin: false, last_login: null, created_at: '2024-01-01', last_activity: null },
      ],
    },
  }),
}));
