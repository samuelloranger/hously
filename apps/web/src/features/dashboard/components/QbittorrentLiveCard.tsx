      ...
      <section className="relative border border-orange-300/60 dark:border-orange-500/30 bg-gradient-to-br from-[#fde8d8] via-[#fbc8a0] to-[#f4845a] dark:from-[#431407] dark:via-[#7c2d12] dark:to-[#c2410c] p-4 shadow-xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-[10px] text-orange-900/70 dark:text-orange-100/90 mt-1">
              {t('dashboard.qbittorrent.subtitle')}
            </p>
            <p className="text-[11px] text-orange-900/70 dark:text-orange-100/80 mt-2">
          ...
          <>
            <div className="mt-5 grid grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="rounded-xl bg-black/10 dark:bg-black/20 p-3">
                <p className="text-[11px] text-orange-950/75 dark:text-orange-200/80">
            ...
            {data?.error && <p className="mt-4 text-[11px] text-orange-950/85 dark:text-orange-100/90">{data.error}</p>}
          </>
        )}
      </section>
    </Link>
