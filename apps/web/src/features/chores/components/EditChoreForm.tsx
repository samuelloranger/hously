...
import { toDateTimeLocal, datetimeLocalToUTC, tomorrow } from "../../../lib/date-utils";
import { useUpdateChore } from "../hooks";
...
export function EditChoreForm({
  ...
  const onSubmit = async (data: FormData) => {
    ...
    if (selectedImage) {
      ...
      try {
        const result = await choresApi.uploadImage(selectedImage);
