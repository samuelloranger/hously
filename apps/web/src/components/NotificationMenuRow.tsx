...
export function NotificationMenuRow({
  ...
  return (
    ...
    >
      {isUnread && <div className="absolute left-0 top-3 bottom-3 w-[3px] rounded-r-full bg-primary-500" />}

      <div className={cn('flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-sm', style.bg)}>
        {style.icon}
      </div>
      ...
      <div className="flex-1 min-w-0">
        ...
        {body && (
          <p
            className={cn(
              ...
              isUnread ? 'text-neutral-600 dark:text-neutral-300' : 'text-neutral-500 dark:text-neutral-400',
            )}
          >
            {body}
          </p>
        ...
        {relativeTime && (
          <p
            className={cn(
              'text-[11px] mt-1',
              isUnread ? 'text-neutral-500 dark:text-neutral-400' : 'text-neutral-400 dark:text-neutral-500',
            )}
          >
            {relativeTime}
          </p>
