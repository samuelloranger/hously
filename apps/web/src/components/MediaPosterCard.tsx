    ...
    <>
      ...
      {showImage && (
        <img
          ...
          className="absolute inset-0 h-full w-full object-cover brightness-[0.85] scale-100 transition-all duration-700 ease-out group-hover:brightness-100 group-hover:scale-105"
        />
      )}
