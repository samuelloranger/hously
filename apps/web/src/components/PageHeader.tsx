...
function iconBg(iconColor: string) {
  if (iconColor === 'text-green-600') return 'bg-emerald-100 dark:bg-emerald-900/30';
  if (iconColor === 'text-blue-600') return 'bg-blue-100 dark:bg-blue-900/30';
  if (iconColor === 'text-orange-600') return 'bg-orange-100 dark:bg-orange-900/30';
    ...
    <div className={cn('mb-6', className)}>
      ...
      <div className="flex flex-col gap-3 sm:hidden">
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0">
            <h1 className="text-lg font-bold tracking-tight text-neutral-900 dark:text-white truncate">{title}</h1>
      ...
      <div className="hidden sm:flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className={cn('flex h-10 w-10 items-center justify-center rounded-xl text-lg', iconBg(iconColor))}>
            {icon}
          </div>
          <div>
            <h1 className="text-xl font-bold tracking-tight text-neutral-900 dark:text-white">{title}</h1>
