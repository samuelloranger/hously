...
export function AddMealModal({ isOpen, onClose, date, mealType, recipes }: AddMealModalProps) {
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {recipe.is_favorite === 1 && <Star className="w-3.5 h-3.5 text-yellow-500 fill-yellow-500 flex-shrink-0" />}
        </div>
