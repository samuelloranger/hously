  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 right-0 z-50 flex w-full flex-col shadow-2xl transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] bg-neutral-900 sm:w-[480px] lg:w-[560px]",
      ...
      >
        {task && (
          <>
            {/* Header */}
            <div className="flex shrink-0 items-center gap-3 border-b px-5 py-4 border-neutral-700/60">
              <span className="flex items-center gap-1.5 rounded-md px-2 py-1 font-mono text-[11px] font-semibold tracking-wide bg-neutral-800 text-neutral-400">
              ...
              {onArchive && (
                <button
                  ...
                  className={cn(
                    ...
                    task.archived
                      ? "hover:bg-primary-900/20 hover:text-primary-400"
                      : "hover:bg-amber-900/20 hover:text-amber-400",
                  )}
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {/* Meta fields grid */}
              <div className="mt-5 grid grid-cols-1 gap-0 border-y border-neutral-800">
                {/* Status */}
                <DrawerField
                ...
                >
                  <select
                    ...
                    className="w-full bg-transparent text-sm font-medium outline-none text-neutral-100"
                  >
                ...
                >
                  <select
                    ...
                    className="w-full bg-transparent text-sm outline-none text-neutral-100"
                  >
                ...
                >
                  <input
                    ...
                    className="w-full bg-transparent text-sm outline-none text-neutral-100 [color-scheme:dark]"
                  />
                </DrawerField>
              ...
              <div className="px-5 py-5">
                ...
                <MinimalTiptap
                  ...
                  compact
                  className="min-h-[160px] rounded-xl border-neutral-700/60"
                />
              </div>

              {/* Time tracking */}
              <div className="border-t px-5 py-5 border-neutral-800">
              ...
              {/* Footer meta */}
              <div className="border-t px-5 py-4 border-neutral-800">
...
function DrawerField({
  ...
  return (
    <div className="flex items-center gap-3 border-b px-5 py-3 last:border-b-0 border-neutral-800">
      <div className="flex w-28 shrink-0 items-center gap-2 text-neutral-500">
        {icon}
