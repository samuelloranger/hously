...
export function HomeAssistantPluginSection() {
  ...
  return (
    <HomeAssistantPluginSectionImpl
...
function HomeAssistantPluginSectionImpl({
  ...
  const handleLoadDevices = async () => {
    try {
      ...
      const msg =
        e instanceof Error ? e.message : t("settings.plugins.saveError");
      toast.error(msg);
    }
  };
  ...
  return (
    <PluginSectionCard
      ...
      configuredValue={data?.plugin?.base_url || undefined}
    >
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder={t(
              "settings.plugins.homeAssistant.accessTokenPlaceholder",
            )}
            autoComplete="off"
            className="w-full px-4 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white font-mono text-sm"
          />
