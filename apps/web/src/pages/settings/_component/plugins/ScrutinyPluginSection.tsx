...
import { useScrutinyPlugin, useUpdateScrutinyPlugin } from '@/hooks/usePlugins';
...
export function ScrutinyPluginSection() {
  ...
  return <ScrutinyPluginSectionImpl key={data?.plugin?.type ?? 'pending'} data={data} isLoading={isLoading} />;
}
