...
export function ServiceTemplateItem({
  ...
  return (
    <div
      className={`border border-neutral-600 rounded-lg p-4 transition-colors ${template.enabled ? "hover:bg-neutral-700" : "opacity-50"}`}
    >
      ...
      {template.enabled && (
        <div className="flex items-center justify-between">
          <div className="flex-1 text-sm text-neutral-400 space-y-1">
            <div>
