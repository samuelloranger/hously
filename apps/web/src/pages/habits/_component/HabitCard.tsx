    ...
    >
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-bold text-neutral-900 dark:text-white leading-tight">{habit.name}</h3>
            {habit.description && (
              <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1 line-clamp-1">{habit.description}</p>
            )}
          </div>
        </div>
