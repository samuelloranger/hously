...
export type HabitsSearchParams = { modal?: 'create' | 'edit'; habitId?: number };
...
export const HabitsList: React.FC = () => {
  ...
  return (
    <PageLayout>
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            className={cn(
              ...
              isToday ? 'text-primary-600 dark:text-primary-400' : 'text-neutral-700 dark:text-neutral-300'
            )}
          >
      ...
      <div>
        {isLoading && habits.length === 0 ? (
          ...
          <div className="flex flex-col items-center gap-4">
            <EmptyState title={t('habits.noHabits')} description={t('habits.addFirstHabit')} icon="🎯" />
            <button
              onClick={() => setParams({ modal: 'create' })}
      ...
      <CreateHabitModal isOpen={isCreateModalOpen} onClose={() => resetParams(['modal'])} />
