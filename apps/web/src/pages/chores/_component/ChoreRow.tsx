...
import { useDeleteChore, useRemoveRecurrence, useToggleChore } from '@/hooks/useChores';
...
export type ChoresSearchParams = { modal?: 'create' | 'edit'; choreId?: number; viewImage?: string };
...
export function ChoreRow({ chore, users, dragHandleProps, setParams, resetParams, searchParams }: ChoreRowProps) {
