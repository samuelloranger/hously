  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="edit_chore_name" className="block text-sm font-medium text-neutral-700 dark:text-neutral-300">
            {t('chores.choreName')}
          </label>
          <input
            type="text"
      ...
      <div>
        <label htmlFor="edit_image" className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
          {t('chores.image')}
        </label>
      ...
      <div className="border-t border-neutral-200 dark:border-neutral-700 pt-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">{t('chores.recurrenceDescription')}</p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              type="checkbox"
              ...
              <div className="flex gap-4">
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm text-neutral-700 dark:text-neutral-300">{t('chores.dailyInterval')}</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm text-neutral-700 dark:text-neutral-300">{t('chores.weekly')}</span>
                </label>
              </div>
            </div>
