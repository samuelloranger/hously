      ...
      <div className="mx-auto w-full max-w-3xl px-6 py-12 sm:py-16">
        <div className="space-y-6">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <h2>Retention</h2>
            <p>
              We retain account and user content while your account is active.
              Security tokens and notification subscriptions are removed when
              they expire, are revoked, or become invalid. Logs are kept for
