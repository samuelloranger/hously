      ...
      >
        <div className="shrink-0 flex items-start justify-between px-5 py-3.5 border-b border-neutral-100 dark:border-neutral-800">
          ...
          <button
            type="button"
            onClick={onClose}
            className="ml-3 mt-0.5 shrink-0 rounded-full p-1.5 text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-600 dark:hover:bg-neutral-800 dark:hover:text-neutral-200"
          >
            <X size={16} />
          </button>
        </div>
