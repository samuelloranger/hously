        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
          ...
          <div className="flex items-center gap-2">
            <span className="flex items-center gap-1">
              <Film size={11} className="shrink-0 text-primary-500 dark:text-primary-400" />
            ...
            <span className="flex items-center gap-1">
              <Tv size={11} className="shrink-0 text-primary-500 dark:text-primary-400" />
              <span className="text-sm font-semibold tabular-nums text-neutral-700 dark:text-neutral-200">
                {showCount}
              </span>
              <span className="text-xs text-neutral-400 dark:text-neutral-500">
      ...
      <div className="flex items-center gap-2">
        ...
        {isAdmin && (
          <Link
            ...
            className="flex h-8 shrink-0 items-center gap-1.5 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-3 text-xs font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
          >
            <Download size={13} />
            <span className="hidden sm:inline">{t("medias.library.downloadsImport")}</span>
          </Link>
        )}
        ...
        <button
          ...
          title="Refresh"
          className={cn(
            "shrink-0 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-2 text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 transition-colors",
            isLoading && "animate-spin text-neutral-300 dark:text-neutral-600 pointer-events-none",
          )}
        >
          <RefreshCw size={13} />
        </button>
