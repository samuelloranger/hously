      ...
      <div className="flex items-center gap-2">
        ...
        {isAdmin && (
          <Link
            ...
            className="flex h-8 w-8 shrink-0 items-center justify-center gap-1.5 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 sm:w-auto sm:px-3 text-xs font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors"
          >
            <Download size={13} />
