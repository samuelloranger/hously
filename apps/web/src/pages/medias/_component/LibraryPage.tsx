...
import { useProwlarrPlugin } from "@/hooks/usePlugins";
import { queryKeys } from "@/lib/queryKeys";
import { PageLayout } from "@/components/PageLayout";
import { PageHeader } from "@/components/PageHeader";
import { Search } from "lucide-react";
import { MediasLibrary } from "@/pages/medias/_component/MediasLibrary";
import { InteractiveSearchDialog } from "@/pages/medias/_component/InteractiveSearchDialog";
...
export function LibraryPage() {
  ...
  const { data: prowlarrData, isLoading: isLoadingProwlarr } =
    useProwlarrPlugin();
  const isProwlarrEnabled = Boolean(
    prowlarrData?.plugin.enabled && prowlarrData.plugin.website_url,
  );
      ...
      <PageHeader
        ...
        actions={
          <button
            ...
            title={
              !isProwlarrEnabled
                ? t("medias.interactive.notConfigured")
