        ...
        <div className="space-y-6">
          ...
          <div className="prose prose-neutral max-w-none dark:prose-invert">
            ...
            <p>
              ...
              infrastructure, managing media pipelines, and organizing daily
              tasks. By using the app, you agree to these terms and to follow
              all applicable laws.
            </p>
            <h2>Accounts</h2>
            <ul>
            ...
            <ul>
              ...
              <li>
                Do not upload content that is illegal or violates others'
                rights.
              </li>
            </ul>
            <h2>Notifications</h2>
            <p>
              If you enable notifications, Hously will send reminders and
              updates through your browser or mobile device. You can disable
              notifications at any time in your device settings.
            </p>
            <h2>Availability</h2>
            <p>
              We aim to keep Hously available, but the service may be
              interrupted for maintenance or unexpected issues.
            </p>
            <h2>Termination</h2>
            <p>
              You can stop using Hously at any time. The administrator of your
              deployment may suspend or remove access if these terms are
              violated.
            </p>
            <h2>Changes</h2>
            <p>
