...
import { type DashboardBeszelSummaryResponse, DASHBOARD_ENDPOINTS } from '@hously/shared';
    ...
    <div>
      ...
      {s.avg_temp_c != null && (
        <MetricRow
          ...
          sub={
            s.hottest_temp_c != null ? t('dashboard.home.maxTemp', { value: s.hottest_temp_c.toFixed(0) }) : undefined
          }
