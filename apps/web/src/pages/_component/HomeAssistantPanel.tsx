...
import { useHomeAssistantControl, useHomeAssistantWidget } from '@/hooks/useHomeAssistant';
...
export function HomeAssistantPanel() {
  ...
  const handleToggle = (entityId: string) => {
    ...
    control.mutate({ entity_id: entityId, action: 'toggle' }, { onSettled: () => setPendingId(null) });
  };
