...
function KpiRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-baseline justify-between gap-3 py-2 border-b border-neutral-800 last:border-0">
      <span className="text-xs text-neutral-400">{label}</span>
      <span className="font-mono text-sm font-semibold tabular-nums text-neutral-100 shrink-0">
        {value}
      </span>
    </div>
  );
        ...
        <div className="space-y-1.5 flex-1 min-w-0">
          {data.map((d) => (
            <div key={d.name} className="flex items-center gap-2">
              ...
              <span className="ml-auto font-mono text-xs font-semibold tabular-nums text-neutral-100 pl-1">
          ...
          <div className="flex items-center gap-2 pt-0.5 border-t border-neutral-800">
            ...
            <span className="ml-auto font-mono text-xs font-bold tabular-nums text-neutral-200 pl-1">
  ...
  return (
    <section className="rounded-xl border border-neutral-800 bg-neutral-900 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-800">
        ...
        <Link
          to="/library"
          className="flex items-center gap-0.5 text-xs font-medium text-neutral-400 hover:text-violet-400 transition-colors"
        >
      ...
      {!isLoading && !isError && stats && (
        <div className="px-4 pb-4 space-y-4 border-t border-neutral-800 pt-3">
