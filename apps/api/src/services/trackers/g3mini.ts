...
const G3MINI_SUBMIT_BUTTON = 'form.auth-form__form button.auth-form__primary-button';
...
export const loginToG3mini = async (page: Page, config: TrackerPluginConfig): Promise<void> => {
