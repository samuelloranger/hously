...
export const handleRadarrWebhook: WebhookHandler = (payload) => {
...
export const handleSonarrWebhook: WebhookHandler = (payload) => {
  const eventType = (payload.eventType as string) || "";
  const variables: Record<string, unknown> = {};
...
export const handleDuplicatiWebhook: WebhookHandler = (payload) => {
  const eventType =
...
export type { WebhookHandler, WebhookResult };
