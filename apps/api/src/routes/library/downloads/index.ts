...
import { assignDownloadFromDisk } from "@hously/api/services/downloadsAssign";
import { scanDownloads } from "@hously/api/services/downloadsScanner";

function mapParsed(
  p: import("@hously/api/services/downloadsScanner").RawDownloadRow["parsed"],
) {
  return {
    title: p.title,
    year: p.year,
